            ...
            $searchDisplay .=
                '<tr class="bg-white border-b hover:bg-gray-50">
					...
					<td class="px-6 py-4 text-right space-x-2 flex items-center">
						<a class="font-medium text-white bg-blue-600 px-2 py-1 rounded hover:bg-blue-700 flex items-center justify-center gap-1 w-fit" href="' . route('categories.edit', ['category' => $category->id]) . '">
						...
						<form class="delete-form inline-block" action="' . route('categories.destroy', ['category' => $category->id]) . '" method="post">' .
                csrf_field() . ' ' . method_field('DELETE') . '
						<button class="delete-btn font-medium text-white bg-red-600 px-2 py-1 rounded hover:bg-red-700 flex items-center justify-center gap-1 w-fit" type="submit"><svg fill="none" height="15" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24" width="15" xmlns="http://www.w3.org/2000/svg">
													<path d="M3 6h18"></path>
