$(document).ready(function() {
                $('#filter-by-date').change(function() {
                    var dateToFilter = $(this).val();
                    $.ajax({
                        url: "/appointments/filter/date",
                        type: 'GET',
                        data: {
						...
						<td class="px-6 py-4 flex flex-col gap-1 xl:block xl:space-x-1">
                            ...
                            `;
									...
									$('.all-appointments').html('');
                                     ...
                                     $('#paginate').addClass('hidden');
                                     $('.error-container').html('<span class="text-center text-xl my-8 text-gray-400">No appointment for this date.</span>')
							}
                        },
