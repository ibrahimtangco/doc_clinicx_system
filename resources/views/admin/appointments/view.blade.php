	...
	<div class="py-6 px-4">
		<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
			<div class="overflow-x-auto">
				<table class="w-full text-sm text-left rtl:text-right text-secondary-text mt-4 mb-8 p-2" id="search-table">
					...
					<tbody class="all-appointments">
						@foreach ($reservations as $reservation)
							<tr class="odd:bg-white even:bg-gray-100 border-b font-medium">
								...
								<td class="px-6 py-3 flex flex-col justify-between items-center gap-1 xl:block xl:space-x-1">
									...
									@else
										<button
											...
											data-reservation-id="{{ $reservation->id }}" data-reservation-status="{{ $reservation->status }}"
