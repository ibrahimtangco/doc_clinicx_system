<x-admin-layout :title="$title">
                    ...
                    <section>
                        <header>
                            <h2 class="text-lg font-medium text-gray-900">
                                {{ __('Update Patient Capacity Entry') }}
                            </h2>

                            <p class="mt-1 text-sm text-gray-600">
                                {{ __('Fill in the required details to update the daily patient capacity for AM and PM slots.') }}
                            </p>
                        </header>

                        <form
                            action="{{ route('daily-patient-capacity.update', ['daily_patient_capacity' => $dailyPatientCapacity]) }}"
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input :value="old('date', $dailyPatientCapacity->date)" autocomplete="date"
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input :value="old('am_capacity', $dailyPatientCapacity->am_capacity)" autocomplete="am_capacity"
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input :value="old('pm_capacity', $dailyPatientCapacity->pm_capacity)" autocomplete="pm_capacity"
    ...
    </script> {{ $errors->has('date') ? 'is-invald' : '' }}
</x-admin-layout>
