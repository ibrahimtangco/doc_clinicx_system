                    ...
                    <section>
                        ...
                        <form action="{{ route('products.store') }}" class="mt-6 space-y-6" method="post">
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input :value="old('name')" autocomplete="name" autofocus class="block mt-1 w-full {{ $errors->has('name') ? 'is-invalid' : ''}}"
                            ...
                            <div class="mt-4">
                                ...
                                <select
                                    ...
                                    @foreach ($categories as $categoryOption)
                                        <option {{ old('category_id') == $categoryOption->id ? 'selected' : '' }}
                            ...
                            <div class="mt-4">
                                ...
                                <select
                                    ...
                                    @foreach ($unitTypes as $unitTypeOption)
                                        <option {{ old('unit_type_id') == $unitTypeOption->id ? 'selected' : '' }}
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input :value="old('quantity')" autocomplete="quantity" autofocus
                                    class="block mt-1 w-full {{ $errors->has('quantity') ? 'is-invalid' : ''}}" id="quantity" name="quantity" type="number" />
                                <x-input-error :messages="$errors->get('quantity')" class="mt-2" />
                            </div>

                            <div class="mt-4">
                                <x-input-label :value="__('Minimum Stock Treshhold')" for="minimum_stock" />
                                <x-text-input :value="old('minimum_stock')" autocomplete="minimum_stock" autofocus
                                    class="block mt-1 w-full {{ $errors->has('minimum_stock') ? 'is-invalid' : ''}}" id="minimum_stock" name="minimum_stock" type="number" />
                                <x-input-error :messages="$errors->get('minimum_stock')" class="mt-2" />
                            </div>

                            <div class="mt-4">
                                <x-input-label :value="__('Buying Price Peso')" for="buying-price" />
                                <x-text-input :value="old('buying_price')" autocomplete="buying-price" autofocus
                                    class="decimal-field block mt-1 w-full text-right {{ $errors->has('buying_price') ? 'is-invalid' : ''}}" id="buying-price"
                                    name="buying_price" placeholder="123.33" step="0.01" type="number" />
                                <x-input-error :messages="$errors->get('buying_price')" class="mt-2" />
                            </div>

                            <div class="mt-4">
                                <x-input-label :value="__('Selling Price in Peso')" for="selling-price" />
                                <x-text-input :value="old('selling_price')" autocomplete="selling-price" autofocus
                                    class="decimal-field block mt-1 w-full text-right {{ $errors->has('selling_price') ? 'is-invalid' : ''}}" id="selling-price"
                                    name="selling_price" placeholder="123.33" step="0.01" type="number" />
