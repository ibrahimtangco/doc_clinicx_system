		...
		<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
			...
			<div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
				...
				<button
					...
					data-modal-hide="default-modal" id="update-phone-number-close-btn" type="button">
			...
			<div class="p-4 md:p-5 space-y-4 relative">
				<form action="{{ route('contacts.update', ['contact' => $contactId]) }}" class="space-y-2" method="POST">
					...
					<div class="w-full">
						...
						<x-text-input :value="old('phone_number')" autofocus class="mt-1 w-full" id="update-phone-number-input" name="phone_number"
							type="text" />
				...
				<form action="{{ route('unset', ['contact' => $contactId]) }}" method="POST" class="absolute right-5 bottom-6">
					...
					@csrf
					<input class="hidden contact-id" name="contact_id" type="text">
					<input class="hidden" id="delete-phone-number-input" name="phone_number" type="text">
