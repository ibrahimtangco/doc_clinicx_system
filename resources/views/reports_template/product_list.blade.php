			...
			<table class="min-w-full border-collapse border border-gray-300 mt-4">
				<thead class="bg-gray-200">
					<tr>
						...
						<th class="border border-gray-300 px-2 py-1 text-center text-gray-700">Buying Price</th>
						<th class="border border-gray-300 px-2 py-1 text-center text-gray-700">Selling Price</th>
					</tr>
				</thead>
				<tbody>
					@foreach ($products as $product)
						...
						<tr class="hover:bg-gray-100">
							...
							<td class="border border-gray-300 px-2 py-1 text-center">{{ $product->unit_type->name }} ({{ $product->unit_type->abbreviation }})</td>
							<td class="border border-gray-300 px-2 py-1 text-center">{{ $product->quantity }}</td>
							<td class="border border-gray-300 px-2 py-1 text-center">{{ number_format($product->buying_price, 2) }}</td>
							<td class="border border-gray-300 px-2 py-1 text-center">{{ number_format($product->selling_price, 2) }}</td>
						</tr>
					@endforeach
				</tbody>
			</table>
